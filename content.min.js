	...
	y.prototype.S = function (definition) {
		...
		if(definition.success) {
			...
			if(!gdc) {
				...
				sheet.insertRule(
					`.posContainer #selectedPartOfSpeech {
						position: relative;
						top: 3px;
					}`
				);
			...
			if(!words.includes(definition.word)) {
				var cardHtml = `
					<div class="header">
						...
						<div class="phonetics">
							${definition.phonetics.map(phonetic => `
								<div class="phonetic" style="position: relative;">
									${
										phonetic.audio ?
					...
					})}</div><div class="posContainer"><span class="igdx_meaningLeft">&#9204;</span><span id="selectedPartOfSpeech" style="width: 45px;">${definition.meanings[0].partOfSpeech}</span><span class="igdx_meaningRight">&#9205;</span></div><div><span id="meaning">${definition.meanings[0].definitions[0].definition}</span></div>
					<div>
					</div>
				`;
