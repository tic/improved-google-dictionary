...
(function () {
	...
	y.prototype.S = function (definition) {
		...
		if(definition.success) {
			...
			var gdc = document.getElementById("GLOBAL_DEFN_CONTAINER");
			if(!gdc) {
				gdc = document.createElement("div");
				gdc.setAttribute("id", "GLOBAL_DEFN_CONTAINER");
				...
				document.documentElement.appendChild(gdc);
		...
		// 		b.audio && (this.H.src = b.audio, this.o.className = "");
		// 		this.m.href = b.moreUrl;
		// 		this.m.textContent = "More »";
		// 		b.attribution && ("translation" === b.type ? (this.D.innerHTML = b.attribution, this.B.className = "display-none",
		// 			this.D.className = "") : (this.K.innerHTML = b.attribution, b = this.K.getElementsByTagName("a")[0], this.B.href = b.href, this.B.innerHTML = b.innerHTML.replace("http://", ""), this.B.className = "", this.D.className = "display-none"), this.h.className = "")
		// 	} else this.j.className = "display-none", this.u.textContent = "No definition found.", this.m.href = "https://www.google.com/search?q=" + encodeURIComponent(a.sanitizedQuery), this.m.innerHTML = 'Search the web for "' + a.sanitizedQuery + '" »';
