...
(function () {
	...
	y.prototype.S = function (definition) {
		if(!definition.success) {
			// Definition not found! we can attempt to forge a definition
			// by checking if the word is one which we have manually defined.
			return;
		}
		...
		function igdx_init() {
			...
			igdx_tabHeader
				...
				.onmousemove = function(event) {
					if(dragActive) {
						igdx_primaryBox.style.left = (positionX - downX + event.clientX) + "px";
						igdx_primaryBox.style.top = (positionY - downY + event.clientY) + "px";
					}
				}
